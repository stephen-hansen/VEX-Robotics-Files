...
task autonomous()
{
  ...
  startTask(pacman);
	if (automode == 1) { //Drive forward
		moving(-127); //Move forward
		wait1Msec(3000); //3 seconds
		moving(0);
		lifting(127); //Lift up, throw over preload
		wait1Msec(2000); //5 seconds
		lifting(0);
		moving(-127); //Push forward to confirm
		wait1Msec(500); //5.5 seconds
		moving(127); //Move back
		wait1Msec(500); //6 seconds
		turning(127*turnDir); //Turn 45 degrees
		wait1Msec(500); //6.5 seconds
		moving(-127); //Move forward
		wait1Msec(1000); //7.5 seconds
		moving(127); //Move back
		wait1Msec(1000); // 8.5 seconds
		turning(-127*turnDir); //Turn back 45 degrees
		wait1Msec(500); //9 seconds
		moving(127); //Move back
		wait1Msec(1000); // 10 seconds
		turning(127*turnDir); //Turn 45 degrees
		wait1Msec(500); //10.5 seconds
		moving(-127); //Move forward
		wait1Msec(2000); //12 seconds
		moving(0); //Stop everything
		soundPlay = true;
		startTask(smbdeath);
		...
		wait1Msec(500); //5.5 seconds
		moving(127); //Move back
		wait1Msec(2000); //7.5 seconds
		turning(-127*turnDir); //Turn back 45 degrees
		wait1Msec(500); //8 seconds
		moving(-127); //Move forward
		wait1Msec(2000); //10 seconds
		turning(127*turnDir); //Turn 45 degrees
		wait1Msec(500); //10.5 seconds
		moving(127); //Move back
		wait1Msec(1000); //11.5 seconds
		turning(-127*turnDir); //Turn back 45 degrees
		wait1Msec(500); //12 seconds
		moving(-127); //Move forward
		wait1Msec(1000); //13 seconds
		moving(0); //Stop everything
		soundPlay = true;
		startTask(smbdeath);
		...
		moving(127); //Move back
		wait1Msec(500); //6 seconds
		lifting(-127); //Move lift down
		wait1Msec(2000); //8 seconds
		turning(127*turnDir); //Turn 45 degrees
		wait1Msec(500); //8.5 seconds
		moving(127); //Move back to get cube
		wait1Msec(1000); //9.5 seconds
		moving(0);
		lifting(127); //Lift cube
		wait1Msec(2000); //10.5 seconds
		lifting(0);
		moving(-127); //Move forward
		wait1Msec(1000); //11.5 seconds
		moving(0);
		lifting(127); //Dump the cube over
		wait1Msec(500); //12 seconds
		lifting(0); //Stop everything
		soundPlay = true;
		startTask(smbdeath);
	}
}
