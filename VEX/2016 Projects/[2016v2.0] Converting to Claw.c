...
#pragma config(Motor,  port7,           liftML,        tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           liftTR,        tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           liftMR,        tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port10,          liftBLR,       tmotorVex393_HBridge, openLoop)
