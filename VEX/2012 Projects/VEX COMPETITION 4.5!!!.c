...
task autonomous()
{
	...
	while(SensorValue(Encoder) < 1100)
		{
		NoTimeDriveStuff(64);
		MoveTurntable(25);
		MoveShoulder(127);
	  ...
	  SensorValue(Encoder) = 1700;
	  while (SensorValue(Encoder) >= 1700)
	  	{
	  	NoTimeDriveStuff(-20);
	  	MoveTurntable(0);
	  	MoveClaw(127);
	  ...
	  SensorValue(Encoder) = 2300;
	  while (SensorValue(Encoder) >= 2300)
	  	{
	  	NoTimeDriveStuff(20);
	  	MoveTurntable(0);
	  	MoveClaw(0);
	  ...
	  SensorValue(Encoder) = 2900;
	  while (SensorValue(Encoder) >= 2900)
	  	{
...
//	  }
//	  if (SensorValue(Encoder) < 1000 && SensorValue(Encoder) > 650)
//	  	{
...
//	  	MoveShoulder(127);
//	  }
//	  if (SensorValue(Encoder) == 1000)
//	  	{
//	  	SensorValue(Encoder) = 1000;
//	  	NoTimeDriveStuff(0);
//	  	MoveElbow(0);
//	  	MoveShoulder(0);
//	  	MoveClaw(127);
...
//dont modify this unless ur stephen (and/or know wat ur doing)
