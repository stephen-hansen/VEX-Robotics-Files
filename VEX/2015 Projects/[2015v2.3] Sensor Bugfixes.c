...
turning:
	while (SensorValue[gyro] > (51 + turn) || SensorValue[gyro] < (-51 + turn)) {
		if ((SensorValue[gyro] > (51 + turn) && SensorValue[gyro] <= (1800 + turn)) || (SensorValue[gyro] < (-1800 + turn))) {
			if (abs(SensorValue[gyro]) > 1800) {
				motor[FR] = floor((3600-abs((SensorValue[gyro]-turn))*127)/450);
				motor[BR] = floor((3600-abs((SensorValue[gyro]-turn))*127)/450);
				motor[FL] = -floor((3600-abs((SensorValue[gyro]-turn))*127)/450);
				motor[BL] = -floor((3600-abs((SensorValue[gyro]-turn))*127)/450);
				} else {
				motor[FR] = floor((abs((SensorValue[gyro]-turn))*127)/450);
				motor[BR] = floor((abs((SensorValue[gyro]-turn))*127)/450);
				motor[FL] = -floor((abs((SensorValue[gyro]-turn))*127)/450);
				motor[BL] = -floor((abs((SensorValue[gyro]-turn))*127)/450);
			}
			}	else if ((SensorValue[gyro] < (-51 + turn) && SensorValue[gyro] >= (-1800 + turn)) || (SensorValue[gyro] > (1800 + turn))) {
			if (abs(SensorValue[gyro]) > 1800) {
				motor[FR] = -floor((3600-abs((SensorValue[gyro]-turn))*127)/450);
				motor[BR] = -floor((3600-abs((SensorValue[gyro]-turn))*127)/450);
				motor[FL] = floor((3600-abs((SensorValue[gyro]-turn))*127)/450);
...
void autoturnToGoal() {
	if (COLOR == 0) { //blue
		...
		TURNANGLE = -asin((goalX - coordX)/DISTANCE)*(3600/(2*PI));
		...
		TURNANGLE = (asin((coordX-goalX)/DISTANCE)*(3600/(2*PI)));
		autoturnAngle(TURNANGLE);
		UNMODIFIEDSPEED = sqrt((DISTANCE*981)/sinDegrees(2*ANGLE));
		SHOOTSPEED = floor((UNMODIFIEDSPEED * 60 * 127)/(120*(2*PI*RADIUS)));
		//Code to convert to SHOOTSPEED goes here
