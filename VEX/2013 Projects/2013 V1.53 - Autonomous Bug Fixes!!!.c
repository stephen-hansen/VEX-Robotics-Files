...
void AutoPlaceholder1() //red
{
	...
	SensorValue(I2C_2) = 0;
  Drive(127,127,1500); //go forward, move arm
  Drive(-127,0,1000); //go back
  Drive(0,-127,200); //move arm down
  Drive(0,25,1000);
  Turn(127,575); //turn right
  Drive(127,0,1500); //go forward
  Turn(-127,575); //turn left
  Drive(127,127,1100); //go forward, move arm
  Drive(-127,0,1000); //go back
  Drive(0,-127,200); //move arm down
}
...
void AutoPlaceholder3() // IN CASE OF EMERGENCY
{
	SensorValue(I2C_1) = 0; //reset sensor
	SensorValue(I2C_2) = 0;
  Drive(127,127,1500);
