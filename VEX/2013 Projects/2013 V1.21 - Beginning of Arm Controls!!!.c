...
#pragma config(Motor,  port2,           ArmMotorR,     tmotorVex393, openLoop)
#pragma config(Motor,  port3,           ArmMotorL,     tmotorVex393, openLoop, reversed)
...
void pre_auton()
{
  ...
  SensorValue(I2C_2) = -(SensorValue(I2C_2));
}
